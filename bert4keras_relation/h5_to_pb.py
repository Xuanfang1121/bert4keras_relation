...
# model = load_model("best_model.h5", custom_objects={"PositionEmbedding": PositionEmbedding,
#                                                     "TotalLoss": TotalLoss})
# model.summary()
...
def h5_to_pb(model_path, h5_pb_path):
    ...
    model = load_model(args["input_model"], args["input_model_json"], custom_objects={"TotalLoss": TotalLoss}) #
...
if __name__ == "__main__":
    ...
    h5_pb_path = "./models/baidu_relation_DuLE_1.0/best_model.pb"
    # todo 报包找不到，怎么解决NameError: name 'batch_gather' is not defined
    h5_to_pb(save_model_path, h5_pb_path)